...
sophie, margot, leo, lampo = User.create! [
  { first_name: 'sophie', last_name: '', street: 'white chair', number: '39', city: 'traffiume', postcode: '28822', country: 'italia' },
  { first_name: 'margot', last_name: '', street: 'red couch', number: '32', city: 'intra', postcode: '22882', country: 'italia' },
